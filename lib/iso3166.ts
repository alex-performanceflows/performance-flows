/**
 * Da codice ISO-3166-1 alpha-3 ad alpha-2.
 * Serve perché Search Console parla in alpha-3 ("ita") mentre Meta, GA4 e
 * la mappa parlano in alpha-2 ("IT"); Intl.DisplayNames accetta solo alpha-2.
 * Tabella ufficiale ISO-3166-1, 248 paesi.
 */
export const ISO3_A_ISO2: Record<string, string> = {
...
/** Alpha-3 (anche minuscolo) → alpha-2. Stringa vuota se sconosciuto. */
export function iso2Da3(codice: string): string {
  return ISO3_A_ISO2[String(codice || "").toUpperCase()] ?? "";
}
