...
const CORRECT_PASSWORD = "vitaedna";
...
export function PasswordGate({ onAuthorized }: { onAuthorized: () => void }) {
  ...
  return (
    <div style={{
      ...
      >
        <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.5)", letterSpacing: "0.08em", textTransform: "uppercase" }}>
          Dashboard VitaeDNA
        </p>
        <h1 style={{ margin: "0.35rem 0 1.25rem", fontSize: 18, fontWeight: 600, letterSpacing: "-0.01em" }}>
          Accesso riservato
        </h1>
