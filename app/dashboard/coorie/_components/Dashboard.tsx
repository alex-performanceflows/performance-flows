...
import {
  CoorieData, fmtDateTime, fmtDate, Skeleton,
...
function DashboardInner() {
  ...
  const [data, setData] = useState<CoorieData | null>(null);
  ...
  return (
    ...
    <div data-theme={theme} style={{
      minHeight: "100dvh",
      background: isDark
        ? "radial-gradient(ellipse at top, #142218 0%, #0d1611 55%, #0a0f0c 100%)"
        : palette.shellBg,
      ...
      <div className="pf-shell">
        ...
        <aside className="pf-sidebar" style={{
          background: isDark ? "rgba(13,22,17,0.85)" : palette.sidebarBg,
        ...
        <div className="pf-mobile-bar" style={{
          background: isDark ? "rgba(13,22,17,0.9)" : palette.sidebarBg,
          backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)",
        ...
        {mobileNavOpen && (
          <div className="pf-mobile-menu" style={{
            display: "none", background: isDark ? "rgba(13,22,17,0.95)" : palette.sidebarBg,
        ...
        <main className="pf-main">
          <div className="pf-noprint" style={{ marginBottom: 18 }}>
            <div style={{
              ...
              <RevenueNoteBanner palette={palette} />
              <DateRangePicker />
            </div>
          </div>
      ...
      <style>{`
        ...
        html, body {
          background: ${isDark ? "#0a0f0c" : "#f0f6fc"};
    ...
    <button onClick={onClick} style={{
      ...
      {active && (
        <span style={{
          ...
          background: `linear-gradient(180deg, ${ACCENT} 0%, ${SAND} 100%)`,
        }} />
      )}
      <span style={{
        display: "inline-flex", alignItems: "center", justifyContent: "center",
