...
const CORRECT_PASSWORD = "onlywood";
...
export function PasswordGate({ onAuthorized }: { onAuthorized: () => void }) {
  ...
  return (
    <div style={{
      minHeight: "100dvh",
      background: `radial-gradient(ellipse at top, ${BRAND_DARK} 0%, #0c1510 55%, #080d0a 100%)`,
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <button type="submit" disabled={!password} style={{
          ...
          background: !password ? "rgba(255,255,255,0.08)" : `linear-gradient(135deg, ${ACCENT} 0%, #3c8a30 100%)`,
